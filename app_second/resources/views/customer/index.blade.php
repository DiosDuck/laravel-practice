        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="col-md-2 text-end">
                    <a href="{{ route('customers.trash') }}" class="btn" style="background-color: black; color: white;"><i class="fas fa-trash-alt"></i> Trash</a>
                </div>
                </div>
                    ...
                    <tbody>
                        @foreach ($customers as $customer)
                            ...
                            <td>
                                ...
                                <a href="javascript:;" onclick="submitDelete({{ $customer->id }})" style="color: #2c2c2c;" class="ms-1 me-1"><i class="fas fa-trash-alt"></i></a>
